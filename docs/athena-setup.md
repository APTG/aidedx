...
| Concern                                         | Setting             | Why                                                                                                                                                                                                                                                                                                              |
| ----------------------------------------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Node, ffmpeg, Python aren't on the default PATH | `module load ...`   | None of these are preinstalled outside the module system on Athena. `Python/3.10.4` specifically (not the default `3.13.5`) — see §3.                                                                                                                                                                            |
